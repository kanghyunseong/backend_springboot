...
import com.kh.pcar.back.admin.cars.model.service.FileSaveService;
...
public class AdminNoticeServiceImpl implements AdminNoticeService {
	...
	public void deleteNotice(Long noticeNo) {
		...
		if(result == 0) {
			throw new NoticeNotFoundException("공지사항 No" + noticeNo + "를 찾을 수 없습니다.");
		}
	...
	public AdminNoticeDTO findNoticeByNo(Long noticeNo) {
		...
		if(adminNoticeDTO == null) {
			throw new NoticeNotFoundException("공지사항 No : " + noticeNo + "에 대한 정보가 없습니다. ");
		}
