...
public class StationController {	
	...
	@GetMapping("/EvCharge")
	public List<MyStationDTO> stations(@RequestParam(name= "lat")String lat,@RequestParam(name="lng")String lng) {
//		log.info("{}",page);
//		log.info("{}",serviceKey);
//		log.info("{}",perPage);
		//현재 위치
		log.info("{},{}",lat,lng);
		List<MyStationDTO> stations = service.stations(lat,lng);
		log.info("{}",stations);
		return stations;
	}
